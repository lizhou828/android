 ...
 * Addr: http://blog.csdn.net/jl_qiqi/article/details/8603695
 */
public class LoadPictureActivity extends Activity{
    protected  static final String TAG  ="LoadPictureActivity";
    ...
    private void initViews() {
        ...
        loaderAdapter = new LoaderAdapter(50,this,URLS);
        listView.setAdapter(loaderAdapter);
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                switch ( scrollState ){
                    case AbsListView.OnScrollListener.SCROLL_STATE_FLING : loaderAdapter.setBusy(true);
                        break;
                    case AbsListView.OnScrollListener.SCROLL_STATE_IDLE : loaderAdapter.setBusy(false);
                        break;
                    case AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL : loaderAdapter.setBusy(false);
                        break;
                    default:
                        break;
                }
    ...
    protected void onDestroy() {
        ...
        if( imageLoader != null ) imageLoader.clearCache();
        super.onDestroy();
    }
}
