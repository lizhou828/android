...
public class MyImageView extends ImageView {
    ...
    private void arithScaleRate() {
        float scaleWidth = BigImageActivity.screenWidth / (float) imageWidth;
        float scaleHeight = BigImageActivity.screenHeight / (float) imageHeight;
    ...
    public void setImageBitmap(Bitmap bitmap) {
        ...
        arithScaleRate();
        //缩放到屏幕大小
        zoomTo(scaleRate,BigImageActivity.screenWidth / 2f, BigImageActivity.screenHeight / 2f);
...
//		RectF rect = new RectF(0, 0, imageWidth*getScale(), imageHeight*getScale());
    ...
    public void layoutToCenter()
    {
        ...
        //空白区域宽高
        float fill_width = BigImageActivity.screenWidth - width;
        float fill_height = BigImageActivity.screenHeight - height;
    ...
    protected float getValue(Matrix matrix, int whichValue) {
        ...
        mMinZoom =( BigImageActivity.screenWidth/2f)/imageWidth;
